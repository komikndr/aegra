...
class Context:
    ...
    num_limit_response_reserve: int = field(
        default=4096,
        metadata={"description": "Reserved tokens for the model response, excluded from input context budget."},
    )
    ...
    agent_id: str | None = field(
        default=None,
        metadata={"description": "Assistant/graph ID used for agent-specific model routing."},
    )
